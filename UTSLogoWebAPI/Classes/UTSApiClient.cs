...
namespace UTSLogoWebAPI.Classes
{
    public static class UTSApiClient
    {
            ...
            SorgulaTekilUrunAsync(string uno, string lno, string sn, string utsToken, string customerName)
        {
            ...
            TekilUrunSorguRequest requestData = new TekilUrunSorguRequest
            {
                Uno = uno,
                Lno = lno,
                San = sn
            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    ...
                    try
                    {
                        UtsTekilUrunYanit apiResponse = JsonConvert.DeserializeObject<UtsTekilUrunYanit>(responseString);
